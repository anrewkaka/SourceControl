<?php
// HTTP
define('HTTP_SERVER', 'http://192.168.1.222/admin/');
define('HTTP_CATALOG', 'http://192.168.1.222/');

// HTTPS
define('HTTPS_SERVER', 'http://192.168.1.222/admin/');
define('HTTPS_CATALOG', 'http://192.168.1.222/');
